...
<body>
    <div class="container">
        <div class="row form-group">
            <div class="col-md-12">
                <h2><a href="index.php" title="Back"><i class="fa fa-arrow-circle-left"></i></a> Example 12:</h2>
            </div> 
    ...
    <script>
        $(function () {
            ...
            $('#country_id').mSelect({
                url: 'ajax/example12.php?q=countries'
            });
            
            //load the states mSelect
            $('#state_id').mSelect({
                url: 'ajax/example12.php?q=states'
            });
            
            //load the cities mSelect
            $('#city_id').mSelect({
                url: 'ajax/example12.php?q=cities',
