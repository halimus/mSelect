...
<head>
    ...
    <!-- mSelect -->
    <link href="../dist/2.0.3/jquery.mSelect.min.css" rel="stylesheet">
...
<body>
    <div class="container">
        <div class="row form-group">
            <div class="col-md-12">
                <h2><a href="index.php" title="Back"><i class="fa fa-arrow-circle-left"></i></a> Example 31:</h2>
            </div> 
            <div class="col-md-12 info">
                <div class="alert alert-info">
                    <p>Navigation buttons on the top:</p>
                    <ul>
                        <li>Load the plugin</li>
                        <li>Add Navigation buttons on the top</li>
                    </ul>
                </div>
            </div> 
        </div>
    ...
    <!-- mSelect -->
    <script src="../dist/2.0.3/jquery.mSelect.min.js"></script>
    <!-- Custom JS -->
    <script>
        $(function () {
            $('#country_id').mSelect({
