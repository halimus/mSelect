...
<body>
    <div class="container">
        <div class="row form-group">
            <div class="col-md-12">
                <h2><a href="index.php" title="Back"><i class="fa fa-arrow-circle-left"></i></a> Example 25: <span class="notice">(Open the Dev Console and check the Log)</span></h2>
            </div> 
