...
<body>
    <div class="container">
        <div class="row form-group">
            <div class="col-md-12">
                <h2><a href="index.php" title="Back"><i class="fa fa-arrow-circle-left"></i></a> Example 09:</h2>
            </div> 
            <div class="col-md-12 info">
                <div class="alert alert-info">
                    ...
                    <ul>
                        ...
                        <li>Custom the mSelect Button width and the "Non Selected Text" label</li>
                    </ul>
                </div>
            </div> 
        </div>
        ...
        <div class="row form-group">
            <div class="col-md-4">
                ...
                <select name="regular_select" class="form-control">
                    <option value=""></option>
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="regular_input" class="form-control" value="">
            </div>
        </div>
