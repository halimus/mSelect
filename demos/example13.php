...
<body>
    <div class="container">
        <div class="row form-group">
            <div class="col-md-12">
                <h2><a href="index.php" title="Back"><i class="fa fa-arrow-circle-left"></i></a> Example 13: <span class="notice">(Open the Dev Console and check the Network)</span></h2>
            </div> 
            <div class="col-md-12 info">
                <div class="alert alert-info">
                    ...
                    <ul>
                        ...
                        <li>Load mSelect data only when open it</li>
                    </ul>
                </div>
            </div> 
        </div>
    ...
    <script>
        $(function () {
            ...
            $('#country_id').mSelect({
                url: 'ajax/example11.php?q=countries',
                loadWhenOpen: true
            });
            
            //load the states mSelect
            $('#state_id').mSelect({
                url: 'ajax/example11.php?q=states',
                loadWhenOpen: true
            });
            
            //load the cities mSelect
            $('#city_id').mSelect({
                url: 'ajax/example11.php?q=cities',
                loadWhenOpen: true
            });
        }); 
    </script> 
