...
<body>
    <div class="container">
        <div class="row form-group">
            <div class="col-md-12">
                <h2><a href="index.php" title="Back"><i class="fa fa-arrow-circle-left"></i></a> Example 10:</h2>
            </div> 
            <div class="col-md-12 info">
                <div class="alert alert-info">
                    ...
                    <ul>
                        ...
                        <li>Allow only Single select for the rows</li>
                    </ul>
                </div>
            </div> 
        </div>
