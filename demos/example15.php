...
<body>
    <div class="container">
        <div class="row form-group">
            <div class="col-md-12">
                <h2><a href="index.php" title="Back"><i class="fa fa-arrow-circle-left"></i></a> Example 15:</h2>
            </div> 
            <div class="col-md-12 info">
                <div class="alert alert-info">
                    ...
                    <ul>
                        ...
                        <li>Custom the Name of the columns</li>
                        <li>Add more than 1 columns for the mSelect</li>
                        <li>Custom the width of the mSelect dropdown container</li>
                        <li>Custom the lengthMenu</li>
                        <li>Custom the column order</li>
                    </ul>
                </div>
            </div> 
        </div>
