...
<body>
    <div class="container">
        <div class="row form-group">
            <div class="col-md-12">
                <h2><a href="index.php" title="Back"><i class="fa fa-arrow-circle-left"></i></a> Example 06:</h2>
            </div> 
            <div class="col-md-12 info">
                <div class="alert alert-info">
                    ...
                    <ul>
                        ...
                        <li>Add a Button that show you the selected rows</li>
                        <li>Custom the ajax variable name for Examples 4 & 5</li>
                    </ul>
                </div>
            </div> 
        </div>
    ...
    <script>
        $(function () {
            $('#country_id').mSelect({
                url: 'ajax/example6.php',
                ajax_var_name: 'my_id', // The name of the variable that we pass via ajax url for the selected rows
                btnSelected:{
                    enable: true
                }
            });
