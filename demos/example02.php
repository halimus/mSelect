...
<body>
    <div class="container">
        <div class="row form-group">
            <div class="col-md-12">
                <h2><a href="index.php" title="Back"><i class="fa fa-arrow-circle-left"></i></a> Example 02:</h2>
            </div> 
                ...
                <div class="alert alert-info">
                    ...
                    <ul>
                       <li>Load the plugin</li>
                        <li>Custom the Name of the column (instead of Name)</li>
                    </ul>
                </div>
            </div> 
        </div>
